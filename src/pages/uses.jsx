  ...
  return (
    <>
      ...
      <SimpleLayout
        ...
        intro="I am often asked about the tools I use to build software, stay productive, or even the ones I buy to convince myself I am being productive when I actually am just procrastinating. Here is a comprehensive list of my favorite tools and gear."
      >
        <div className="space-y-20">
          <ToolsSection title="Workstation">
            <Tool title="16” MacBook Pro, 6-Core i7, 32GB RAM (2019)">
              Believe it or not, before I was using the MacBook, I was a PC
              person. I still cannot believe I used a PC all those years as it
          ...
          <ToolsSection title="Productivity">
            <Tool title="Raycast">
              Although I was a long-time user of Alfred, I have found Raycast to
