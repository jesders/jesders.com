    ...
    <>
      ...
      <Container className="mt-16 sm:mt-32">
        <div className="prose-invert prose prose-h2:text-zinc-600 prose-p:mt-6 prose-p:space-y-7 prose-p:text-base prose-p:text-zinc-600 prose-blockquote:rounded prose-blockquote:border-l-4 prose-blockquote:border-l-teal-400 prose-blockquote:bg-zinc-50 prose-blockquote:py-2 prose-blockquote:px-6 prose-blockquote:text-zinc-600 prose-blockquote:shadow-lg prose-blockquote:shadow-zinc-800/5 prose-li:mt-6 prose-li:space-y-7 prose-li:text-base prose-li:text-zinc-600 dark:prose-h2:text-white dark:prose-p:text-zinc-400 dark:prose-blockquote:bg-zinc-800/50 dark:prose-blockquote:text-zinc-200 dark:prose-li:text-zinc-400">
          ...
          <p>
            I am excited about the opportunity to bring my expertise to the Web
            Developer role at Tailscale. I have a passion for executing designs
            with pixel perfect attention to detail, enjoyable user experiences,
            and intuitive interfaces while also ensuring that my work is
          ...
          <p>
            I am enthusiastic about the opportunity at Tailscale, where I aspire
            to contribute to innovative and impactful projects. I look forward
            to collaborating with a team that shares my dedication to creating
            meaningful solutions and driving positive change in our community.
            The prospect of working with an ideal tech stack is particularly
            exciting, as I believe it will not only enable me to excel in my
            contributions but also provide valuable opportunities for
