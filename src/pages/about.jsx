        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            ...
            <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
              ...
              <p>I joined Storyware in 2020 as a web developer. I bring over 11 years of web development to the Storyware team, specializing in frontend technologies. I am passionate about responsive workflows, user experience, and delivering high-quality web applications.</p>
              <p>Before working at Storyware, I worked as a lead frontend developer, where I was in charge of managing all frontend technologies as well as making sure projects were built as efficiently as possible.</p>
